...
<br>
<br>
![example printout](images/example_printout.png)
...
[Macdown](https://github.com/MacDownApp/macdown/releases/download/v0.7.1/MacDown.app.zip) is a great application to edit your markdown files and see the changes in real time.
